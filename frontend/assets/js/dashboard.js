...
(function ()
{
  ...
  var module_script = {
    ...
    courses: function ()
    {
      ...
      {
        console.log("Adding Course Line 617");
        console.log(data);
        if (data.status == 200)
        {
          ...
          var current_time_zone_offset = n / 60;

          var all_time_zones = {
            '0': '<option value="0"><font size="+2">GMT/UTC</font></option>',
            '1': '<option value="1"><font size="+2">ECT &nbsp&nbsp  GMT/UTC+1</font></option>',
            '2': '<option value="2"><font size="+2">EET &nbsp&nbsp  GMT/UTC+2</font></option>',
            '3': '<option value="3"><font size="+2">EAT &nbsp&nbsp  GMT/UTC+3</font></option>',
            '4': '<option value="4"><font size="+2">NET &nbsp&nbsp  GMT/UTC+4</font></option>',
            '5': '<option value="5"><font size="+2">PLT &nbsp&nbsp  GMT/UTC+5</font></option>',
            '6': '<option value="6"><font size="+2">BST &nbsp&nbsp  GMT/UTC+6</font></option>',
            '7': '<option value="7"><font size="+2">VST &nbsp&nbsp  GMT/UTC+7</font></option>',
            '8': '<option value="8"><font size="+2">CTT &nbsp&nbsp  GMT/UTC+8</font></option>',
            '9': '<option value="9"><font size="+2">JST &nbsp&nbsp  GMT/UTC+9</font></option>',
            '10': '<option value="10"><font size="+2">AET &nbsp&nbsp  GMT/UTC+10</font></option>',
            '11': '<option value="11"><font size="+2">SST &nbsp&nbsp  GMT/UTC+11</font></option>',
            '12': '<option value="12"><font size="+2">NST &nbsp&nbsp  GMT/UTC+12</font></option>',
            '-11': '<option value="-11"><font size="+2">MIT &nbsp&nbsp  GMT/UTC-11</font></option>',
            '-10': '<option value="-10"><font size="+2">HST &nbsp&nbsp  GMT/UTC-10</font></option>',
            '-9': '<option value="-9"><font size="+2">AST &nbsp&nbsp  GMT/UTC-9</font></option>',
            '-8': '<option value="-8"><font size="+2">PST &nbsp&nbsp  GMT/UTC-8</font></option>',
            '-7': '<option value="-7"><font size="+2">PNT &nbsp&nbsp  GMT/UTC-7</font></option>',
            '-6': '<option value="-6"><font size="+2">CST &nbsp&nbsp  GMT/UTC-6</font></option>',
            '-5': '<option value="-5"><font size="+2">EST &nbsp&nbsp  GMT/UTC-5</font></option>',
            '-4': '<option value="-4"><font size="+2">PRT &nbsp&nbsp  GMT/UTC-4</font></option>',
            '-3': '<option value="-3"><font size="+2">BET &nbsp&nbsp  GMT/UTC-3</font></option>',
            '-1': '<option value="-1"><font size="+2">CAT &nbsp&nbsp  GMT/UTC-1</font></option>'
          };

          var nearest_time_key = '0';
          var min_distance = 100;
          for (key_str in all_time_zones)
          {
            var diff_val = current_time_zone_offset - parseInt(key_str);
            if (diff_val < 0)
            {
              diff_val = diff_val * -1;
            }
            if (diff_val < min_distance)
            {
              min_distance = diff_val;
              nearest_time_key = key_str;
            }
          }

          var time_zone_html = all_time_zones[nearest_time_key];
          for (key_str in all_time_zones)
          {
            time_zone_html += all_time_zones[key_str];
          }
          ...
          var addCourseCard = $('<div class="mdl-card mdl-shadow--2dp mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet"><div class="mdl-card__title mdl-card--expand mdl-color--black mdl-color-text--white"><h2 class="mdl-card__title-text">Add a new course</h2></div>'
            ...
            //+
            '<label for="timezone"><font size="+1">Choose Timezone:</font></label>&nbsp&nbsp&nbsp' +

            '<select id="timezone" name="timezone" STYLE="font-size : 13pt">' +
            time_zone_html +
            '</select>'
            +
            ...
            '</form></div>'
            +
            '<div class="mdl-card__actions mdl-card--border"><div class="mdl-layout-spacer"></div><button id="confirm_course_btn" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">Confirm</button></div></div>');
          ...
          addCourseCard.find('button').click(function ()
          {
            ...
            var timeZoneVal = document.querySelector('select[name=timezone]').value;
    ...
    reflections: function ()
    {
      ...
      $('main > .mdl-grid').append('<div class="title mdl-cell--12-col mdl-color-text--grey-800"> <h3>View summarized detailes for Course:</h3> <div class="lecture-course-dropdown"> <span id="lecture-course-name">Please Wait...</span><button id="lecture-course-btn" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon"><i class="material-icons" role="presentation">arrow_drop_down</i><span class="visuallyhidden">Courses</span></button> <ul class="mdl-menu--bottom-right" for="lecture-course-btn"></ul> </div> </div>');
