			...
			this.template = '<div class="dtp hidden" id="' + this.name + '">' +
								'<div class="dtp-content">' +
									...
									'<div class="dtp-buttons">' +
										'<button class="dtp-btn-now mdl-button mdl-button--accent btn-flat hidden">' + this.params.nowText + '</button>' +
										'<button class="dtp-btn-clear mdl-button mdl-button--colored btn-flat hidden">' + this.params.clearText + '</button>' +
										'<button class="dtp-btn-cancel mdl-button mdl-button--colored btn-flat">' + this.params.cancelText + '</button>' +
										'<button class="dtp-btn-ok mdl-button mdl-button--colored btn-flat">' + this.params.okText + '</button>' +
										'<div class="clearfix"></div>' +
									'</div>' +
								'</div>' +
							'</div>';
